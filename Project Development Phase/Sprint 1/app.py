...
client = vonage.Client(key="460bb91a", secret="HrQBNBzYTqEjN3Bw")
...
conn = ibm_db.connect("DATABASE=bludb;HOSTNAME=9938aec0-8105-433e-8bf9-0fbb7e483086.c1ogj3sd0tgtu0lqde00.databases.appdomain.cloud;PORT=32459;SECURITY=SSL;SSLServerCertificate=DigiCertGlobalRootCA.crt;UID=znq27181;PWD=7e8exZArImt54FxF","","")
...
def requested():
	...
	if request.method == 'POST':
		...
		while dictionary != False:
			print(dictionary[0])
			mail_msg = Mail(from_email='mugilanandamr@gmail.com',to_emails=''+dictionary[0],
						subject='Need Plasma',html_content='<strong>'+msg+'</strong>')
			sg = SendGridAPIClient("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")
			...
			# # url="https://www.fast2sms.com/dev/bulk?authorization=u5RsN6dCEbgL1gp4CCqSTQTbSC2avsEG922e4YWzLUSdl244F7ssVPkT0RU9&sender_id=FSTSMS&message="+msg+"&language=english&route=p&numbers="+str(phone)
